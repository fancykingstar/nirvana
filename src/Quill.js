...
class CruiseTheme extends BaseTheme {
    ...
    extendToolbar(toolbar) {
        ...
        this.tooltip = new CruiseTooltip(this.quill, this.options.bounds);
...
CruiseTheme.DEFAULTS = extend(true, {}, BaseTheme.DEFAULTS, {
    modules: {
        toolbar: {
            handlers: {
                link: function (value) {
...
class CruiseTooltip extends BaseTooltip {
